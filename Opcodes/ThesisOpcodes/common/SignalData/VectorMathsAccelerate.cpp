...
template <typename T> Vector<T> &Vector<T>::fill(const T input) {
...
template <typename T> Vector<T> &Vector<T>::multiply(const T input) {
...
template <> Vector<double> &Vector<double>::multiply(const double input) {
...
template <> Vector<double> &Vector<double>::divide(const double input) {
...
template <typename T> Vector<T> &Vector<T>::add(const T input) {
...
template <typename T> Vector<T> &Vector<T>::add(StridedVector<T> &input) {
...
template <typename T> Vector<T> &Vector<T>::exponent() {
...
template <> Vector<double> &Vector<double>::exponent() {
...
template <typename T> Vector<T> &Vector<T>::cosine() {
...
template <> Vector<double> &Vector<double>::cosine() {
...
template <typename T>
void Vector<T>::add(const Vector<T> &inputA, const Vector<T> &inputB,
                    Vector<T> &output) {
...
template <typename T>
void Vector<T>::divide(const Vector<T> &inputA, const T &scalar,
                       Vector<T> &output) {
    assert(inputA.elementCount == output.elementCount);
...
template <typename T>
void Vector<T>::multiply(const Vector<T> &input, const T &scalar,
                         Vector<T> &output) {
    T *outData = (T *)output.data;
...
template <>
void Vector<double>::multiply(const Vector<double> &input, const double &scalar,
...
template <typename T>
void Vector<T>::multiply(const Vector<T> &inputA, const Vector<T> &inputB,
                         Vector<T> &output) {
    assert(inputA.elementCount == inputB.elementCount);
    assert(inputA.elementCount == output.elementCount);
...
template <typename T>
void Vector<T>::subtract(const StridedVector<T> &inputA,
                         const Vector<T> &inputB, Vector<T> &output) {
    assert(inputA.elementCount == inputB.elementCount);
    assert(inputA.elementCount == output.elementCount);
...
template <typename T>
void Vector<T>::subtract(Signals::Vector<T> &input, double scalar,
...
template <typename T>
void Vector<T>::subtract(Vector<T> &inputA, Vector<T> &inputB,
                         Vector<T> &output) {
    assert(inputA.elementCount == inputB.elementCount);
    assert(inputA.elementCount == output.elementCount);
...
template <>
void Vector<double>::subtract(Vector<double> &inputA, Vector<double> &inputB,
                              Vector<double> &output) {
    assert(inputA.elementCount == inputB.elementCount);
    assert(inputA.elementCount == output.elementCount);
...
template <>
double Vector<double>::dotProduct(const Vector<double> &inputA,
...
template <typename T>
void Vector<T>::outerProduct(const Vector<T> &inputA, const Vector<T> &inputB,
                             Matrix<T> &output) {
    assert(inputA.elementCount == inputB.elementCount);
...
template <typename T> Vector<T> &Vector<T>::sineWindow() {
