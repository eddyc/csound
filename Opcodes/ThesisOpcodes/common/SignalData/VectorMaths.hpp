...
static void multiply(const Vector<T>& inputA, const Vector<T>& inputB, Vector<T>& output);
static void subtract(const StridedVector<T>& inputA, const Vector<T>& inputB, Vector<T>& output);
static void subtract(Signals::Vector<T>& input, double scalar, Signals::Vector<T>& output);
